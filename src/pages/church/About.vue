  ...
  >
    ...
    <div class="q-mt-md">
      <div class="row ">
        ...
        <p class="clearfix margin-bottom5" />

        <div
          v-for="list in gole3"
          :key="list.num"
          class="col-md-4 col-sm-4 q-pa-sm"
        >
          <div>
            <h4 class="text-h5">
              {{ list.title }}
...
const gole3 = [
  { num: '1', title: '말씀이 살아있는 교회', des: '온전하며, 모든 선한 일을 행할 수 있는 능력을 갖춘 하나님의 사람을 세우기 위해 말씀을 스스로 읽고 묵상하는 Q.T목회를 지향하고 있습니다.' },
  { num: '2', title: '예배의 감격이 있는 교회', des: '상한 영혼을 회복시키며, 강한 믿음의 용사로 거듭나게 하는 영감있는 예배, 즉 성령님의 임재가 있는 예배를 제공하는 것에 역량을 집중하고 있습니다.' },
  { num: '3', title: '가정에 행복을 주는 교회', des: '인격이 형성되며, 지치고 상한 마음이 회복되는 장소인 가정이 작은 천국이 되도록 상한 가정은 회복시키고, 건강한 가정은 더욱 견고히 세우는 노력을 하고 있습니다.' }
]
