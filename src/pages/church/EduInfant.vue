<template>
  ...
  >
    ...
    <div class="q-col-gutter-md justify-center">
      <div
        class="col-md-5 col-sm-5 col-xs-11 q-ma-md  text-weight-bold"
      >
        <q-icon
          name="mdi-book-clock"
          size="32px"
    ...
    <div class="q-pa-md">
      <div class="col-md-5 col-sm-5 col-xs-11 q-mb-md text-weight-bold">
        <q-icon
          name="photo"
          size="32px"
          color="orange-5"
...
const content = {
  ...
  location: '중1층 영아부실',
  serving: [
    { title: '지도', name: '송경미 전도사' },
    { title: '부장', name: '김진희 권사' },
    { title: '총무', name: '이선영 집사' },
    { title: '반주', name: '김정현 집사' }
  ],
  activityImg: [
